...
class StoreNhanVienRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'CCCD' => 'nullable|string|max:20|unique:nhan_viens,CCCD',
            'NGAYSINH' => 'nullable|date|before:today',
            'SODIENTHOAI' => 'nullable|string|regex:/^[0-9]{10,15}$/',
            'EMAIL' => 'nullable|email|max:100|unique:nhan_viens,EMAIL',
            'DIACHI' => 'nullable|string|max:255',
            'NGAYTHAMGIA' => 'nullable|date',
            'MACHUCVU' => 'required|integer|exists:chuc_vus,MACHUCVU',
        ];
    }
