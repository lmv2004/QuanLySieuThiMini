...
class UpdateNhaCungCapRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'TENNCC' => 'sometimes|required|string|max:200',
            'DIACHI' => 'sometimes|nullable|string|max:255',
            'SDT' => 'sometimes|nullable|string|regex:/^[0-9]{10,15}$/|unique:nha_cung_caps,SDT,' . $supplierId . ',MANCC',
            'EMAIL' => 'sometimes|nullable|email|max:100|unique:nha_cung_caps,EMAIL,' . $supplierId . ',MANCC',
        ];
    }
