...
export const ImportImportExport = ({ onRefresh, addToast, data }) => {
    ...
    return (
        <div className="voucher-import-export">
            ...
            {isOpen && (
                <Modal
                    title="Công cụ Nhập / Xuất Phiếu nhập"
                    onClose={handleClose}
                    actions={
                        <>
                            ...
                            {mode === 'import' ? (
                                ...
                                <div className="ie-form-section">
                                    <div className="form-group">
                                        ...
                                        <input type="text" className="ie-input" placeholder={`imports_${new Date().getTime()}`} value={exportName} onChange={(e) => setExportName(e.target.value)} />
